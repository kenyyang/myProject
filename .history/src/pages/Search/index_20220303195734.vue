      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 平台的售卖的属性值展示 -->
             <li class="with-x" v-for="(attrValue, index) in searchParams.props" :key="index" >{{attrValue.split(':')[1]}}<i @click="removeAttrValue">x</i></li>
          </ul>
        </div>
...
export default {
  ...
  methods: {
    ...
    attrInfo(attrs,attrValue){
      ...
      // 数组去重
      if(this.searchParams.props.indexOf(pro))
      this.getData()
