        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAtt in spuSaleAttrList" :key="spuSaleAtt.id">
                <dt class="title">{{ spuSaleAtt.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{active:spuSaleAttrValue.isChecked==1}"
                  v-for="spuSaleAttrValue in spuSaleAtt.spuSaleAttrValueList"
...
export default {
  ...
  methods:{
    ...
    aw  this.$store.dispatch('addOrUpdateShopCart',{skuId: this.$route.params.skuId,skuNum:this.skuNum} )
