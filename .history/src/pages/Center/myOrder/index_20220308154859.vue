        ...
        <table class="order-item" v-for="order in myOrder.records" :key="order.id" >
          ...
          <tbody>
            <tr v-for="detail in order.orderDetailList" :key="detail.id" >
              ...
              <td :rowspan="detail.length" width="8%" class="center">{{order.consignee}}</td>
              <td :rowspan="detail.length" width="13%" class="center">
                <ul class="unstyled">
                  <li>总金额¥{{order.totalAmount}}.00</li>
                  <li>在线支付</li>
                </ul>
              </td>
              <td :rowspan="detail.length" width="8%" class="center">
